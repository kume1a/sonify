...
void createDbTables(Batch batch) {
  batch.execute(
    '''
      ...
      (
        ${Audio_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${AudioLike_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${DownloadedTask_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${UserAudio_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${Playlist_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${PlaylistAudio_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
  ...
  batch.execute(
    '''
      ...
      (
        ${UserPlaylist_.id} TEXT PRIMARY KEY NOT NULL ON CONFLICT REPLACE,
