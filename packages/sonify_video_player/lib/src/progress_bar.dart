...
class _VideoProgressBarState extends State<VideoProgressBar> {
  ...
  void _seekToRelativePosition(Offset globalPosition) {
    videoPlayerController.seekTo(context.calcRelativePosition(
  ...
  Widget build(BuildContext context) {
    ...
    return controller.draggableProgressBar
        ? GestureDetector(
            onHorizontalDragStart: (DragStartDetails details) {
              if (!videoPlayerController.value.isInitialized) {
                return;
              }
              _controllerWasPlaying = videoPlayerController.value.isPlaying;
...
class _ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double playedPartPercent =
        (draggableValue != Duration.zero ? draggableValue.inMilliseconds : value.position.inMilliseconds) /
