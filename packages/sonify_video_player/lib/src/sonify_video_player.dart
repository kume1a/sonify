...
typedef SonifyVideoPlayerRoutePageBuilder = Widget Function(
  BuildContext context,
  Animation<double> animation,
  Animation<double> secondaryAnimation,
  SonifyVideoPlayerControllerProvider controllerProvider,
);
...
class SonifyVideoPlayer extends StatefulWidget {
  ...
  @override
  SonifyVideoPlayerState createState() {
    return SonifyVideoPlayerState();
  }
}

class SonifyVideoPlayerState extends State<SonifyVideoPlayer> {
  ...
  @override
  void didUpdateWidget(SonifyVideoPlayer oldWidget) {
  ...
  Widget build(BuildContext context) {
    return SonifyVideoPlayerControllerProvider(
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    final controllerProvider = SonifyVideoPlayerControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const PlayerWithControls(),
...
class SonifyVideoPlayerController extends ChangeNotifier {
  SonifyVideoPlayerController({
  ...
  SonifyVideoPlayerController copyWith({
    ...
    SonifyVideoPlayerProgressColors? cupertinoProgressColors,
    SonifyVideoPlayerProgressColors? materialProgressColors,
    Widget? placeholder,
    Widget? overlay,
    ...
    Widget Function(
      ...
      Animation<double>,
      Animation<double>,
      SonifyVideoPlayerControllerProvider,
    )? routePageBuilder,
  }) {
    return SonifyVideoPlayerController(
  ...
  /// Build your own options with default options shiped through
  /// the builder method. Just add your own options to the Widget
  /// you'll build. If you want to hide the options, just leave them
  ...
  /// Add your own additional options on top of options
  ...
  /// Defines customised controls. Check [VideoControls] or
  ...
  final SonifyVideoPlayerProgressColors? cupertinoProgressColors;

  /// The colors to use for the Material Progress Bar. By default, the Material
  /// player uses the colors from your Theme.
  final SonifyVideoPlayerProgressColors? materialProgressColors;
  ...
  final SonifyVideoPlayerRoutePageBuilder? routePageBuilder;
  ...
  static SonifyVideoPlayerController of(BuildContext context) {
    final provider = context.dependOnInheritedWidgetOfExactType<SonifyVideoPlayerControllerProvider>()!;
...
class SonifyVideoPlayerControllerProvider extends InheritedWidget {
  ...
  @override
  bool updateShouldNotify(SonifyVideoPlayerControllerProvider oldWidget) =>
