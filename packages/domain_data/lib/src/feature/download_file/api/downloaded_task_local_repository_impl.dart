...
class DownloadedTaskLocalRepositoryImpl with ResultWrap implements DownloadedTaskLocalRepository {
  ...
  @override
  Future<Result<int>> save(DownloadedTask downloadedTask, {UserAudio? payloadUserAudio}) {
    return wrapWithResult(() async {
      final downloadedTaskEntity = _downloadedTaskMapper.modelToEntity(downloadedTask);
